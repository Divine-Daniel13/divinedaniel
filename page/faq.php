...
<!-- Mirrored from htmldemo.net/lendex/lendex/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Aug 2025 14:12:00 GMT -->
<head>
...
<body>
    ...
    <main class="main-wrapper">
        ...
        <!-- ...::: Start FAQ Section :::... -->
        <div class="faq-section section-gap-tb-165">
            <div class="faq-box">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="faq-wrapper">
                                <div class="faq-list-section">
                                    <!-- Start FAQ List Single Item -->
                                    <div class="faq-list-single-item">
                                        <div class="number">01.</div>
                                        <div class="content">
                                            <h4 class="title">How to start UI/UX Design?</h4>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry an orem Ipsumhas been the industry's standard dummy text ever since the 1500s, when an unknown printtook a galley of type and scrambled book.</p>
                                        </div>
                                    </div>
                                    <!-- End FAQ List Single Item -->
                                    <!-- Start FAQ List Single Item -->
                                    <div class="faq-list-single-item">
                                        <div class="number">02.</div>
                                        <div class="content">
                                            <h4 class="title">Why you read UI design blog?</h4>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry an orem Ipsumhas been the industry's standard dummy text ever since the 1500s, when an unknown printtook a galley of type and scrambled book.</p>
                                        </div>
                                    </div>
                                    <!-- End FAQ List Single Item -->
                                    ...
                                    <div class="faq-list-single-item">
                                        ...
                                        <div class="content">
                                            <h4 class="title">How to improve design quality?</h4>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry an orem Ipsumhas been the industry's standard dummy text ever since the 1500s, when an unknown printtook a galley of type and scrambled book.</p>
                                        </div>
                                    </div>
                                    <!-- End FAQ List Single Item -->
                                    ...
                                    <div class="faq-list-single-item">
                                        ...
                                        <div class="content">
                                            <h4 class="title">How to easily start user testing?</h4>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry an orem Ipsumhas been the industry's standard dummy text ever since the 1500s, when an unknown printtook a galley of type and scrambled book.</p>
                                        </div>
                                    </div>
                                    <!-- End FAQ List Single Item -->
