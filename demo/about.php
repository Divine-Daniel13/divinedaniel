...
<!-- Mirrored from htmldemo.net/lendex/lendex/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Aug 2025 14:11:57 GMT -->
<head>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col">
                            <div class="header-btn-link text-end">
                                <a href="#" class="btn btn-sm btn-outline-one icon-space-left">Hire Me <i class="icofont-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
